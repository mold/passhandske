...
void setup() {
  int[] a = new int[] {500, 505, 500, 500, 550, 550, 550, 500, 500, 550, 550, 550, 500, 500, 500};
  int[] b = new int[] {500, 550, 550, 500, 500, 550, 550, 550, 500};
  int[] c = new int[] {500, 500, 500, 500, 500, 560, 555, 560, 570, 510, 500, 550, 550, 550, 500};
  int[] d = new int[] {500, 600, 600, 590, 590, 560, 600, 600, 590, 570, 510, 500, 550, 550, 600, 500};
  int[] e = new int[] {500, 500, 500, 500, 550, 550, 545, 500, 500, 550, 550, 550, 500, 500, 500};
  println(pm.normalizeVector(a));
}
